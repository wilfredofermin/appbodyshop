...
class AdminController extends Controller
{
    ...
    public function index(){
            ...
            //$today=Carbon::today();
            ////////////////////////////////////////////////////////////////////////////////////////////////////
            return view('administrar.index')->with(compact('categories','sucursales','services','areas',
                    'solicitudes','c_solicitudes','c_pendientes','c_rechazados','c_completo', 'ultimo_pendiente','completos','complit','c_en_proceso','m_solicitudes')
            );
